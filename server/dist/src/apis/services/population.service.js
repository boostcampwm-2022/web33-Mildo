...
exports.default = {
    getRecentAreaPopulation: function () { return __awaiter(void 0, void 0, void 0, function () {
        var result, areaPopulation, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4, population_repository_1.default.findRecent()];
                case 2:
                    areaPopulation = _a.sent();
                    if (areaPopulation) {
                        areaPopulation.map(function (populationInfo) {
